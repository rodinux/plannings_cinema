...
class VillagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create village" do
    assert_difference('Village.count') do
      post villages_url, params: { village: { commune: @village.commune, salle: @village.salle } }
    end
  ...
  test "should update village" do
    patch village_url(@village), params: { village: { commune: @village.commune, salle: @village.salle } }

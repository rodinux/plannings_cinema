Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "plannings_cinema_#{Rails.env}"

  config.action_mailer.perform_caching = false
  config.action_mailer.delivery_method = :sendmail
  config.action_mailer.default_url_options = { host: "programme.ecranvillage.deploiement.ovh", port: 25}

...
class SeancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seance" do
    assert_difference('Seance.count') do
      post seances_url, params: { seance: { caisse: @seance.caisse, horaire: @seance.horaire, projection: @seance.projection } }
    end
  ...
  test "should update seance" do
    patch seance_url(@seance), params: { seance: { caisse: @seance.caisse, horaire: @seance.horaire, projection: @seance.projection } }

...
class FilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create film" do
    assert_difference('Film.count') do
      post films_url, params: { film: { description: @film.description, titrefilm: @film.titrefilm } }
    end
  ...
  test "should update film" do
    patch film_url(@film), params: { film: { description: @film.description, titrefilm: @film.titrefilm } }
